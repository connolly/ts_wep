...
def getBscDbType(bscDbType):
    ...
    elif bscDbType == 'refCat':
        return BscDbType.LocalDbFromRefCat
    else:
...
def getDeblendDonutType(deblendDonutType):
    ...
    elif deblendDonutType == "convolveTemplate":
        return DeblendDonutType.ConvolveTemplate
    else:
